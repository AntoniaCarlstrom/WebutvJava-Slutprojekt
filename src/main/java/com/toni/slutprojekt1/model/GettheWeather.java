...
public class GettheWeather {
    ...
    public static void getWeather(weatherBean wBean) throws IOException {
        String API_KEY = "03662fcf7a5409f3e489e4afce34ae72";
        ...
        // Create a Node list that gets everything in and under the "humidity" tag
        ...
        for (int temp = 0; temp < nList.getLength(); temp++) {
            ...
            if (node.getNodeType() == Node.ELEMENT_NODE) {
                ...
                Element eElement = (Element) node;
                // get the content of an attribute in element
                String XMLhum = eElement.getAttribute("value");

                // and print it
                System.out.println(wBean.getCityStr() + " is now a " + XMLhum);
                // save it
                wBean.setHumStr(XMLhum);
